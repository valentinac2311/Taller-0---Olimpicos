...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el el nombre del país al cual representa el atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	/**
	 *  Le nformarle al usuario el nombre del país al cual representa el atleta.
	 */
	private void ejecutarPaisRepresentando()
	{
		System.out.println("\n" + "El nombre del país al cual representa el atleta" + "\n");
		
		String atleta = input("Por favor ingrese el nombre del atleta");
		
		String pais = calculadora.buscarPaisRepresentando(atleta);
		
		System.out.println("El nombre del país al cual representa el atleta es " + pais + "%");

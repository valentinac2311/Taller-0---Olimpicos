...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el nombre del país al cual representa el atleta
	 * 
	 * @param nombreAtleta El nombre del atleta que se está buscando
	 * @return El país al cual representa el atleta o null si no se encuentra.
	 */
	
	public String buscarPaisRepresentando(String nombreAtleta)
	{
		Atleta elAtleta = null;
        String elPais = "No está";
